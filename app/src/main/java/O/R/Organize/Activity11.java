    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent int2 = new Intent(Activity11.this,Activity2.class);
                startActivity(int2);
            }
        });
    ...
    protected void checki(int i)
    {
        if(i==4) {
            if (num1 == 1 && num2 == 1 && num3 == 1 && num4 == 1) {
                AlertDialog alertDialog = new AlertDialog.Builder(Activity11.this).create();
                alertDialog.setTitle("Level Passed \u2713");
                alertDialog.setMessage("Ferrari 458 -$200-500k CAD\nG-Wagon - $148-160k CAD\nAudi TT  2019 Version - $44.5-50k CAD\nFord Mustang Convertible - $36-40k CAD");
                alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Next Level",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                Intent intent2 = new Intent(Activity11.this, Activity12.class);
                ...
                alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "Back to Menu",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                Intent int3 = new Intent(Activity11.this, Activity2.class);
                                startActivity(int3);
                            }
                        });
