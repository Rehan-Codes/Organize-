    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent int2 = new Intent(Activity13.this,Activity2.class);
                startActivity(int2);
            }
        });
    ...
    protected void checki(int i)
    {
        if(i==4) {
            if (num1 == 1 && num2 == 1 && num3 == 1 && num4 == 1) {
                AlertDialog alertDialog = new AlertDialog.Builder(Activity13.this).create();
                alertDialog.setTitle("Level Passed \u2713");
                alertDialog.setMessage("RAF Typhoon Jet - $212M CAD\nJames Joyce, Dubliners (First Edition) - $10k-500k CAD\nCompanion Encyclopedia Of Psychology - $500-700 CAD\nTexas Instruments TI-Nspire CX II CAS - $200-$500 CAD");
                alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Next Level",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                Intent intent2 = new Intent(Activity13.this, Activity14.class);
                ...
                alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "Back to Menu",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                Intent int3 = new Intent(Activity13.this, Activity2.class);
                                startActivity(int3);
                            }
                        });
