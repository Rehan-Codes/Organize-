    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent int2 = new Intent(Activity30.this, Activity2.class);
                startActivity(int2);
            }
        });
    ...
    protected void checki(int i) {
        if (i == 4) {
            if (num1 == 1 && num2 == 1 && num3 == 1 && num4 == 1) {
                AlertDialog alertDialog = new AlertDialog.Builder(Activity30.this).create();
                alertDialog.setTitle("Level Passed \u2713");
                alertDialog.setMessage("Cessna 206 Seaplane - 280km/h\nCessna 208 Caravan - 344km/h\nGulfStream G450 Private Jet - 1,078km/h\nF22 Raptor Jet - 3,414km/h");
                alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Next Level",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                Intent intent2 = new Intent(Activity30.this, Activity31.class);
                ...
                alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "Back to Menu",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                Intent int3 = new Intent(Activity30.this, Activity2.class);
                                startActivity(int3);
                            }
                        });
