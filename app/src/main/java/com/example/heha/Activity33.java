    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent int2 = new Intent(Activity33.this, Activity2.class);
                startActivity(int2);
            }
        });
    ...
    protected void checki(int i) {
        if (i == 4) {
            if (num1 == 1 && num2 == 1 && num3 == 1 && num4 == 1) {
                AlertDialog alertDialog = new AlertDialog.Builder(Activity33.this).create();
                alertDialog.setTitle("Level Passed \u2713");
                alertDialog.setMessage("Jellyfish - 8km/h\nBeluga Whale - 28km/h\nShark - 50km/h\nDolphin - 60km/h");
                alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Next Level",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                Intent intent2 = new Intent(Activity33.this, Activity34.class);
                ...
                alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "Back to Menu",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                Intent int3 = new Intent(Activity33.this, Activity2.class);
                                startActivity(int3);
                            }
                        });
