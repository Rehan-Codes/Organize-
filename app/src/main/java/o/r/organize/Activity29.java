    ...
    protected void checki(int i) {
        if (i == 4) {
            if (num1 == 1 && num2 == 1 && num3 == 1 && num4 == 1) {
                AlertDialog alertDialog = new AlertDialog.Builder(Activity29.this).create();
                alertDialog.setTitle("Level Passed \u2713");
                alertDialog.setMessage("Tri-Deck Boat - 30km/h\nSpeedboat - 80km/h\nKawaski W650 Bike - 180km/h\nBugatti Chiron - 420km/h");
                alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Next Level",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                Intent intent2 = new Intent(Activity29.this, Activity30.class);
                ...
                alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "Back to Menu",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                Intent int3 = new Intent(Activity29.this, Activity2.class);
                                startActivity(int3);
                            }
                        });
