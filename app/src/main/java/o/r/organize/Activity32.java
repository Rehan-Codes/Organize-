    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent int2 = new Intent(Activity32.this, Activity2.class);
                startActivity(int2);
            }
        });
            ...
            if (num1 == 1 && num2 == 1 && num3 == 1 && num4 == 1) {
                ...
                alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Next Level",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                Intent intent2 = new Intent(Activity32.this, Activity33.class);
                ...
                alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "Back to Menu",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                Intent int3 = new Intent(Activity32.this, Activity2.class);
                                startActivity(int3);
                            }
                        });
